...
#     filename='D:\Git\DifferentialPrivacywork\APDPk-means/output/'+now+'myDPBlood_out.csv'
#     return filename
...
# # load对照数据
# kmeansdata=pd.read_csv('D:\Git\DifferentialPrivacywork\APDPk-means\output/h8/h8result_normal.csv',header=None)
...
# savesse.to_csv('D:\Git\DifferentialPrivacywork\APDPk-means\output/s1/sse.csv',header=False,index=False)
# savef1.to_csv('D:\Git\DifferentialPrivacywork\APDPk-means\output/s1/f1.csv',header=False,index=False)
